...
P=R/'Handbook_Master_001-251_v13.pdf';out=R/'proofs/checkpoint13';out.mkdir(parents=True,exist_ok=True)
def render(n):
...
with ThreadPoolExecutor(max_workers=2) as ex:rows=list(ex.map(render,range(241,252)))
