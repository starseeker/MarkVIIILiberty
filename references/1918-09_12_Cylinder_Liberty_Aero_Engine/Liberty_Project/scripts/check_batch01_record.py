...
for i,p in enumerate(src):
 ...
 mapping.append(dict(comparison_page=i+1,source_leaf=i+1,master_page=i+1,label=label))
...
for n,p in enumerate(src,1):p.get_pixmap(matrix=fitz.Matrix(2,2)).save(review/f'final_{n:02}.png')
print('20 pages verified; exact per-page native/PDF character inventory matches; no text outside pages. Comparison written.')
