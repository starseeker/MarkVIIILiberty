...
P=R/'Handbook_Master_001-240_v12.pdf';out=R/'proofs/checkpoint12';out.mkdir(parents=True,exist_ok=True)
def render(n):
...
with ThreadPoolExecutor(max_workers=2) as ex:rows=list(ex.map(render,range(221,241)))
