"""Run inside Scribus to insert a new consecutive figure batch into the saved master.
...
def main():
 ...
 assert all(str(n) in transforms for n in numbers)
 ...
 s.setInfo('Ordnance Department; digital reconstruction',
  'S. N. L. No. G-13 — complete supplied-page draft',
