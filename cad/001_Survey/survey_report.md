# Mark VIII tank: source survey and CAD preparation

**Survey date:** 13 September 2026  
**Repository revision:** `a938a6e475da3263ede6a68b956da6d613964c26`  
**Requested scope:** [cad/001_Survey/intent.txt](https://github.com/starseeker/MarkVIIILiberty/blob/a938a6e475da3263ede6a68b956da6d613964c26/cad/001_Survey/intent.txt), both survey passes and the geometry-readiness assessment.
...
The deliverable is `mark_viii_parts.sqlite`, accompanied by its schema, frozen inputs, rebuild scripts, example queries, validation results, this report, and a snapshot of the repository's transcription/reconstruction text sources. It has **5,482 conservative canonical records**, **3,879 assembly/arrangement assertions**, and **1,054 records linked across sources**. These are inventory identities and source assertions, not the number of manufactured pieces in one tank. Assemblies, features, equipment sets, alternatives, and unresolved identities are explicitly distinguishable.

## 1. Source inventory and scope

| ID | Source | PDF pages | Pinned repository source |
| --- | --- | --- | --- |
| SNL | Standard Nomenclature List G-13 (30 March 1928) | 314 | [PDF 1](https://github.com/starseeker/MarkVIIILiberty/blob/a938a6e475da3263ede6a68b956da6d613964c26/references/1928-03-30_SNL_G13/1928-03-30_SNL_G13_MarkVIII_Liberty.pdf) |
| HB | Preliminary Handbook of the Mark VIII Tank (1918; 1925 reprint) | 251 | [PDF 1](https://github.com/starseeker/MarkVIIILiberty/blob/a938a6e475da3263ede6a68b956da6d613964c26/references/1925-03-06_Preliminary_Handbook_Mark_VIII_Tank/Preliminary_Handbook_MarkVIII_Tank_Part_1_of_5.pdf), [PDF 2](https://github.com/starseeker/MarkVIIILiberty/blob/a938a6e475da3263ede6a68b956da6d613964c26/references/1925-03-06_Preliminary_Handbook_Mark_VIII_Tank/Preliminary_Handbook_MarkVIII_Tank_Part_2_of_5.pdf), [PDF 3](https://github.com/starseeker/MarkVIIILiberty/blob/a938a6e475da3263ede6a68b956da6d613964c26/references/1925-03-06_Preliminary_Handbook_Mark_VIII_Tank/Preliminary_Handbook_MarkVIII_Tank_Part_3_of_5.pdf), [PDF 4](https://github.com/starseeker/MarkVIIILiberty/blob/a938a6e475da3263ede6a68b956da6d613964c26/references/1925-03-06_Preliminary_Handbook_Mark_VIII_Tank/Preliminary_Handbook_MarkVIII_Tank_Part_4_of_5.pdf), [PDF 5](https://github.com/starseeker/MarkVIIILiberty/blob/a938a6e475da3263ede6a68b956da6d613964c26/references/1925-03-06_Preliminary_Handbook_Mark_VIII_Tank/Preliminary_Handbook_MarkVIII_Tank_Part_5_of_5.pdf) |
| LIB | The 12 Cylinder Liberty Aero Engine (September 1918) | 162 | [PDF 1](https://github.com/starseeker/MarkVIIILiberty/blob/a938a6e475da3263ede6a68b956da6d613964c26/references/1918-09_12_Cylinder_Liberty_Aero_Engine/1918-09_12_Cylinder_Liberty_Aero_Engine.pdf) |
| GUN | Hotchkiss 2.244-inch 6-pdr 6-cwt Mk II Gun with Tank Mounting (1919) | 32 | [PDF 1](https://github.com/starseeker/MarkVIIILiberty/blob/a938a6e475da3263ede6a68b956da6d613964c26/references/1919-08-15_Handbook_QF_Hotchkiss_2.244in_6pdr/1919-08-15_Handbook_QF_Hotchkiss_2.244in_6pdr.pdf) |
| JORDAN | Harry B. Jordan, Manufacture of Mark VIII Tanks (1920), pp. 27-33 | 8 | [PDF 1](https://github.com/starseeker/MarkVIIILiberty/blob/a938a6e475da3263ede6a68b956da6d613964c26/references/1920-07_Manufacture_of_Mark_VIII_Tanks/1920-07_Manufacture_of_Mark_VIII_Tanks.pdf) |
| PATENT | Herbert W. Alden, U.S. Patent 1,366,550 (1921) | 4 | [PDF 1](https://github.com/starseeker/MarkVIIILiberty/blob/a938a6e475da3263ede6a68b956da6d613964c26/references/1921-01-25_US1366550A/US1366550A_cleanup.pdf) |
...
| Tables | Purpose and interpretation |
| --- | --- |
...
| --- | --- | --- |
| A_SIMPLE_GEOMETRY | 2 | Complete nominal external primitive: the 1/4-inch and 1-inch steel balls. Tolerance/finish and placement are separate. |
| B_DOCUMENTED_FORM | 1077 | Explicit illustrated or described form, or named integral feature. Full dimensional/placement sufficiency has not been demonstrated. |
| C_ENGINEERING_APPROXIMATION | 1005 | Dimensioned hardware or partial dimensional description suitable for a controlled period-engineering approximation after checking standards and interfaces. |
| D_INSUFFICIENT | 3394 | Identity/arrangement evidence alone in the normalized inventory, or a blocking dimensional conflict. Requires more evidence. |
| N_NON_GEOMETRIC | 4 | Bulk consumable; may be represented as a volume or annotation if useful. |
...
| Feature | Source value | Source and scope |
| --- | --- | --- |
...
| Subsystem | What the collection supports | Remaining evidence needed |
| --- | --- | --- |
...
| Lead / priority | Source candidate | What was verified | Use and limitation |
| --- | --- | --- | --- |
| R01 / P1 | [Progress Report of the National Screw Thread Commission](https://www.govinfo.gov/content/pkg/GOVPUB-C13-ad6e50706050b71202040ad8fadfe95c/pdf/GOVPUB-C13-ad6e50706050b71202040ad8fadfe95c.pdf) — 1921; approved 19 June 1920 | Digitized primary-source PDF opened; title/approval verified | Period thread-series and dimensional reference for generic hardware reconstruction Postdates initial design; match source U.S. Std./SAE/pipe/USF designation rather than apply indiscriminately |
| R02 / P1 | [Report of the National Screw Thread Commission, revised 1924, MP 61](https://nvlpubs.nist.gov/nistpubs/Legacy/MP/nbsmiscellaneouspub61.pdf) — 1925 | Digitized primary-source PDF opened; title and preface verified | Hardware standards, pipe threads, wood screws and stated revisions from 1921 Revised fit classes and later specifications; useful comparison for 1928 catalog, not proof of original 1918 geometry |
| R03 / P2 | [Illustrated catalogue and price list](https://catalog.hathitrust.org/Record/100164840) — 1908 | Catalog record opened; 564 pages, institutional full-view link; item pages not inspected | Candidate comparison for SH962H modified 1/8-inch regulating-tank cock Need actual catalog entry and modification drawing; modern valve products are not substitutes |
| R04 / P2 | [The Timken reference manual](https://catalog.hathitrust.org/Record/002023883) — 1942 | Catalog record opened; 192 pages and full-view link verified; bearing table not inspected | Look for historical cone/cup dimensions for 316/312 and 6454/6420 Later than tank; continuity of exact numbers and profiles remains unverified |
| R05 / P3 | [Part 312 single-cup product page](https://cad.timken.com/item/tapered-roller-bearings---single-cups/tapered-roller-bearings---single-cups---imperial/312) — current | Manufacturer page opened; part identity and separate cup/cone construction verified | Current envelope cross-check and possible CAD reference for cup 312 Not period evidence; no historical interchangeability inferred and no dimensions imported |
| R06 / P2 | [Homer Jackson Dana Catalog and Brochure Collection, Cage 88, Box 2 Folder 10](https://archiveswest.orbiscascade.org/ark:80444/xv60565) — 1915-1922 material; Willard 1918 pamphlet and Zenith c.1917 pamphlet | Institutional finding aid opened; named items and location verified; pamphlet images not retrieved | Willard battery construction literature; Zenith compound-nozzle explanation Finding aid is not a digitized catalog. No SYR-13 / STR-4 or modified U.S. 52 dimensional match established |
| R07 / P3 | [Automobile Ignition, Starting, and Lighting, Charles B. Hayward](https://books.google.com/books/about/Automobile_Ignition_Starting_and_Lightin.html?id=PE8iAQAAMAAJ) — 1916; other digitized editions listed | Period book metadata/preview opened; title and scope verified | Contemporary electrical construction and illustrations; candidate Bijur comparison Not a vendor parts catalog; tank-specific Bijur generator, starter and T461 switch match unverified |
| R08 / P1 | [Record Group 156: Office of the Chief of Ordnance](https://www.archives.gov/research/guide-fed-records/groups/156.html) — 1915-1941 record series, including 1918-1920 | Official archival guide opened; drawing/correspondence series lead | Original Ordnance drawings, 1922 O.C.M. 2344 carburetor decision, production changes and tank installation details Series-level lead only; no individual engineering sheet recovered |
| R09 / P1 | [SNL G-13 Changes No. 1; common hardware SNL H-1/H-2/H-5/H-6/H-7 and G-9](https://github.com/starseeker/MarkVIIILiberty/blob/main/references/1928-03-30_SNL_G13/1928-03-30_SNL_G13_MarkVIII_Liberty.pdf) — 1928 references; supplement date unverified | Primary-source cross-references in SNL notes pp. 308-311; separate scans not located | Fill spare/accessory omission and identify exact standard Ordnance hardware Requested document families, not claims of newly found digitized scans |
| R10 / P1 | Ball and Ball tank carburetor drawing or period catalog — 1919-1920 production | Exact tank-specific digitized source not located in this search | Largest component-document gap for original Rock Island engine appearance and interfaces Later automotive Ball & Ball/Carter catalogs cannot establish tank shape |
| R11 / P1 | Bijur tank generator, starting motor and T461 switch drawings — 1918-1928 | Exact tank-specific digitized catalog not located; SNL note (gy) explains unit-only coverage | Dimensions, end frames, terminals and mounting feet of proprietary equipment Do not reconstruct internal details from a generic dynamo illustration |
| R12 / P2 | Johns-Manville distance recorder M-26 and tachometer; Edelman gauge — 1918-1928 | Exact period product manuals not located; SNL pp. 97,162,214,244 give identities | Gauge diameters, cases, mounting patterns, drive threads and cable interfaces Dimensions and vendor continuity unverified |
| R13 / P2 | Titeflex/Penflex hose and fitting catalogs; period drive-chain catalogs — 1918-1928 | Exact relevant digitized editions not located; SNL pp. 2,61-62,73,263 provide starting specifications | End fitting geometry, braid appearance, bend radii, chain form SNL lengths and threads retained; generic modern hoses/chains are only provisional geometry |
| R14 / P2 | Stanley No. 808 hinge and Appleton Unilet catalogs — 1918-1928 | Exact period catalog matches not located; SNL p. 106 and pp. 264-265 establish names | Leaf shape, knuckles and hole spacing; conduit-box castings and threaded entries 2½-inch hinge size does not alone establish pattern |
| R15 / P1 | Mark VIII Tank, Ordnance Notes and Handbooks on Guns and Gun Carriages — Series 1900-August 1941; Rock Island creator | Archive panel transcribed in repository foldout_provenance.json; external item availability not independently checked | Specific series identifier 26417262, container 5, item Mark VIII Tank; stronger starting point for requesting original plates or associated handbook material Identifier is for the cited archival record/series, not an assertion that every tank drawing is digitized |
