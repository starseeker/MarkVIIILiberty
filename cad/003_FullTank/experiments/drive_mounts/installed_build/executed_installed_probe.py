...
source=source.replace(old,'(X(1630),Z(500)),(X(1800),Z(500))]')
...
report=dict(passed=not overlaps and all(s['passed'] for s in seats+bore_checks),
    ...
    hypothesis='Swap initial inner M1977/M1978 fore/aft geometric slots to agree with bearing/cross-member source allocations; continue the inferred lower border level from [1630,500] to [1800,500], where it terminates naturally against the rising hull outline. Source calibration and shaft axes remain unchanged.',
