...
# Inferred scallops clear the neighboring bearing screw/rivet heads while
# retaining the full nut-flat contact and the separate locking-screw ear.
locking=drill(locking,bolts,2*(31.75/math.sqrt(3)+a['locking_head_clearance']))
