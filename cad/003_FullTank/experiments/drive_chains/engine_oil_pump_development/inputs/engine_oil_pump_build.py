...
try:
    ...
    inputs=[Path(__file__),HERE/'engine_oil_pump_assembly.py',HERE/'engine_oil_pump_parts.py',HERE/'engine_oil_pump_services.py',HERE/'engine_oil_pump_strainers.py',controls,HERE/'engine_oil_pump_sources.json',HERE/'engine_crossmember_parts.py',HERE/'transmission_planet_parts.py',HERE/'transmission_stud_parts.py',HERE/'transmission_core_parts.py']
