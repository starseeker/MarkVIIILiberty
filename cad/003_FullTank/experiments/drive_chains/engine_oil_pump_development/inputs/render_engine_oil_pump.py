...
try:
    ...
    names=[]
    for name,direction in [('isometric',(.7,-1,.55)),('cutaway',(.8,-1,.45)),('gear_core',(.7,-1,.5)),('exploded',(.7,-1,.4)),('relief',(.5,-1,.2))]:
        items=[]
    ...
    for suffix,view in [('figure_027_original.png','gear_core'),('figure_029_original.png','cutaway'),('figure_030_original.png','relief'),('figure_033_original.png','exploded'),('p305.jpg','exploded')]:
