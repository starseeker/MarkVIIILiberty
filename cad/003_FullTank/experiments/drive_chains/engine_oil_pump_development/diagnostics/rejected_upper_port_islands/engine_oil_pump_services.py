...
def extend(c,p,occ,groups,d):
    ...
    front=[(c['return_inlet_port_x'],c['return_inlet_port_y'],1),(c['return_inlet_port_x'],c['return_inlet_port_y'],-9),(-40,28,-9),(30,28,-9),(30,space/2,-9),(30,space/2,14),(13,space/2,14)]
    supply=[(-30,-space/2,-40),(-30,-space/2,-9),(-13,-space/2,-9)]
    outlet=[(-13,space/2,14),(-30,space/2,14),(-30,space/2,-12),(-38,40,-12),(-38,c['lower_body_radius']+4,-12)]
    ...
    for name in ['pressure','front_sump','filtered_supply','common_return','relief']:
        outer=channel(paths[name],stock);lo=lo.fuse(outer.common(box(-150,150,-150,150,-100,0)))
