...
old_base = archived('transmission_core_build', 'TransmissionCoreCandidate.FCStd', name, 'core', 'case_original_base')
...
write(out / 'report.json', dict(status='saved_frame_trial_pending_independent_checks',
    ...
    frame_and_floor_unchanged=True, occurrence_frames_unchanged=True,
