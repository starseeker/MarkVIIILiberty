...
try:
    ...
    t=r['datums']['taper'];clip=Part.makeBox(t['front']-t['rear']+35,200,65,origin+App.Vector(t['rear']-30,-100,0))
    draw(['EngineCrank_Forging','EngineCrank_FlywheelKey','EngineCrank_FlywheelKeyScrew','EngineCrank_OutputNut','EngineCrank_OutputCotter','ClutchDrum_flywheel'],
         'output_section','Output taper, key and retention | section through existing clutch flywheel; registration conditional',(0,-.15,-1),clip)
