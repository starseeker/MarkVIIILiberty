"""Whole-material comparison of the four track-rod end joints against retained tank geometry."""
import argparse
import itertools
...
for name,one in targets.items():
    ...
    for n,box in boxes.items():
        if not overlap(bb,box):continue
