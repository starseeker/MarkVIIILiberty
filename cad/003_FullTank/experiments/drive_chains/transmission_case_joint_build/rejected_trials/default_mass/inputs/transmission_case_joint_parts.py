...
def case_joint_parts(c, old_case, old_cover):
    ...
    for y,z in axes:
        ...
        reliefs.extend([cylinder_x(c['relief_radius'],-seat-35,-seat,y,z),
                        cylinder_x(c['relief_radius'],seat,seat+35,y,z)])
    ...
    seals=[s.cut(Part.makeCompound(radial)).removeSplitter() for s in seals]
