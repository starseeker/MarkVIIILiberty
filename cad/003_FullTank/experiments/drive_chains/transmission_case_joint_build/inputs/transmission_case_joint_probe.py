...
try:
    ...
    names=['transmission_case_joint_probe.py','transmission_case_joint_parts.py','transmission_case_joint_controls.json','transmission_case_joint_sources.json',
        'transmission_stud_parts.py','transmission_input_calibration.json','case_joint_mass.py','case_joint_mass.cpp',
    ...
    for name in exchange_ids:
        ...
        # Independent mass diagnostic bounded by the surfaces' existing
        # representation tolerance. Raw and bounded material checks stay fixed.
        # Adaptive integration avoids FreeCAD's default mass quadrature error.
        ...
        checks.append(dict(id=name,native_max_tolerance_mm=ta,step_max_tolerance_mm=tb,comparison_fuzzy_tolerance_mm=fuzzy,tolerance_reporting_roundoff_mm=1e-10,
            ...
            default_volume_difference_mm3=abs(s.Volume-v.Volume),adaptive_native=mn,adaptive_step=ms,
            adaptive_volume_difference_mm3=dv,surface_tolerance_volume_envelope_mm3=volume_bound,adaptive_center_difference_mm=dc,
