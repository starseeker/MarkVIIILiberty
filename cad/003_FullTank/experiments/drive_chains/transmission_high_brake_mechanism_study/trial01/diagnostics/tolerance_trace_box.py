...
s=s.replace("boss=Part.makeCylinder(c['lever_bearing_radius'],c['lever_upper_seat_distance']-seat,V(0,0,seat))","boss=Part.makeBox(2*c['lever_bearing_radius'],width,c['lever_upper_seat_distance']-seat,V(-c['lever_bearing_radius'],-width/2,seat))")
