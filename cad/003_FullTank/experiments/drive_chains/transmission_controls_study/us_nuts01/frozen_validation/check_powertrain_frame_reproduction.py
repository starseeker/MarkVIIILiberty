"""Compare two independently built, saved transmission-support trials without loading FreeCAD."""
import argparse
import hashlib
import json
...
result = dict(
    ...
    scope='Fresh nominal transmission-support rebuild from the same saved source; no historical qualification.',
