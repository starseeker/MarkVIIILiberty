"""Render actual saved high-speed spring supports and compare them through the unchanged local source registration."""
import argparse
...
shaded(items,out/'high_spring_isometric.svg',(-1,-1,.8),'Rear controls | two high-speed spring supports; clearance study',context=floor)
shaded([v for v in items if v['id'].startswith('PortHighSpring')],out/'high_spring_detail.svg',(-1,-1,.5),'M4135 | guide bracket and two source-listed rivets')
