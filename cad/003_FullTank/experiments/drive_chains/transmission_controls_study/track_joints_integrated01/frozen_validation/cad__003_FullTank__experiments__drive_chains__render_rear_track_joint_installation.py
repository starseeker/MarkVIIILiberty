...
shaded(items+context, out/'track_joints_isometric.svg', (-1, -1, .8),
       'Rear track controls | installed fork / pin / cotter / nut joints; rods pending')
...
write(out/'render_receipt.json', dict(native_sha256=sha(native), parent_native_sha256=sha(parent),
      ...
      scope='16 saved joint components from the full3262-component hierarchy, saved receiver/channel/support context, fixed side projection. No completed rods, spring attachments or historical photographic fit.',
