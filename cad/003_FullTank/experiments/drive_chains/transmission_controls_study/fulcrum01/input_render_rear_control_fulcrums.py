...
rows={v['name']:v for v in m['occurrences']};prior={v['name']:v for v in old['occurrences']}
...
for name,row in rows.items():
    role=r['specs'][name]['role'];system='Channel' if role=='channel' else 'Bracket' if role=='bracket' else 'Lever' if role.startswith('lever') else 'Hardware'
