...
try:
    ...
    for delta in [-1,1]:
        ...
        for name in ['main_bore_radius','collar_body_radius','key_bed_radius','support_radius','support_flange_radius','snap_ridge_radius']:c[name]+=delta
        ...
        seating=[('ClutchStack_bearing','ClutchCollar_collar',0),('ClutchStack_sleeve','ClutchCollar_collar',0),
            ('ClutchStack_bearing','ClutchStack_sleeve',0),('ClutchStack_bearing','ClutchStack_snap',0),
