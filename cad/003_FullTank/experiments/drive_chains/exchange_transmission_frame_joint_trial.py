...
assert len(definitions)==10 and len(installed_names)==45
...
write(out / 'exchange_checks.json', dict(passed=all(v['passed'] for v in results),
    ...
    scope='Nine receiving definitions, one rivet definition and 45 affected installed components; not a full-tank export.',
