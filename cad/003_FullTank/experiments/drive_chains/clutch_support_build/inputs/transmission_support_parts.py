...
def parts(controls, picks, calibration, sleeves):
    ...
    for role in ['inner','outer']:
        ...
        lid_seat=box(cup_back-c['lid_overhang']-c['lid_gap'],cup_front+c['lid_overhang']+c['lid_gap'],
                     -c['cup_width']/2-c['lid_overhang']-c['lid_gap'],c['cup_width']/2+c['lid_overhang']+c['lid_gap'],
