...
views=[('isometric',frame,context,(-1,-.8,.6),'Frame connections trial | formed returns, diaphragm overlap and 32 source-counted rivets'),
       ('frame_front',frame,[],(1,-.25,.35),'Frame interior | mechanical joint hypothesis; remaining hardware unpopulated'),
       ('gusset_joint',detail,[],(1,-.7,.85),'Upper inner corner | display crop; formed gusset and three source-sized rivets')]
