"""Compare all inherited brake-suspension definition material with its saved parent.
...
the two newly added definitions.
"""
import argparse
...
assert qualification['local_suspension_checks_passed']
...
result = dict(passed=all(v['passed'] for v in records), native_sha256=report['native_sha256'],
              ...
              scope='All 464 inherited child definitions compared with the qualified frame-joint parent. Does not qualify placements or historical interpretation.',
