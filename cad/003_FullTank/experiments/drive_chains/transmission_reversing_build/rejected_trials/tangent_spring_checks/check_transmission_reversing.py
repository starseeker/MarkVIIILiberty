...
try:
    ...
    zero('spring contained within printed OD and installed height',s['spring'].cut(cz(17.4625/2,186,214,x,-135)))
    ...
    check('spring has at least twelve complete meridian intersections',sum(w.isClosed() for w in section.Wires)>=12)
