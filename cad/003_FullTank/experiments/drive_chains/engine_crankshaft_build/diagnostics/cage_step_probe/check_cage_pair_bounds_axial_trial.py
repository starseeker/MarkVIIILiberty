...
try:
    ...
    for pair in delta['removed']:
        ...
        assert abs(axial_gap - expected_gap) < 1e-5
        ...
        results.append(dict(a=a, b=b, gap_mm=gap, axial_bbox_gap_mm=axial_gap, minimum_gap_mm=expected_gap,
    ...
    receipt = dict(passed=True, previous_native_sha256=hashes[0], native_sha256=hashes[1],
                   ...
                   initial_probe_correction='Sleeve/cage surfaces are also radially separated; axial bounding gap is a lower bound on Euclidean distance, not an equality.',
