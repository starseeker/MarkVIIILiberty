...
assert changed == set()
assert len(source_manifest['definitions']) == 545
...
result = dict(passed=all(v['passed'] for v in records), native_sha256=report['native_sha256'],
              ...
              scope='All545 inherited definitions preserved, including the older clutch nut. One new U.S. Standard nut definition and the two reassigned occurrence targets are checked separately. Does not qualify placements or historical interpretation.',
