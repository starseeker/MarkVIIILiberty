...
from transmission_high_brake_front_parts import parts,rotate_theta
bands={}
...
for key,s in changed.items():
 body=doc.getObject(key);body.Tip.Shape=s
 metadata(body,ParameterUpdate='Regenerate with build_transmission_high_brake_front.py',ReconstructionStatus='Rear joints retained; forward fitting and source-counted lining hardware receiving holes installed. Estimated terminal profiles remain conditional.')
