"""Export and strictly compare brake-stop/bearing definitions and all 76 affected installed components."""
import argparse
import math
...
assert len(definitions)==13 and len(installed_names)==76
...
write(out / 'exchange_checks.json', dict(passed=all(v['passed'] for v in results),
    ...
    scope='Thirteen new/changed definitions and all 76 affected occurrences; adaptive converged mass integration and unchanged strict material/tolerance criteria. Not a complete brake mechanism or full-tank export.',
