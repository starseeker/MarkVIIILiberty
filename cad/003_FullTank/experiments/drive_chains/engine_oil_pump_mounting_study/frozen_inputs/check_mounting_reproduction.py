...
root=Path('/home/cyapp/MarkVIIILiberty');a=root/'cad/003_FullTank/experiments/drive_chains/engine_oil_pump_mounting_study';b=root/'.work/engine-oil-pump/mounting_reproduction'
