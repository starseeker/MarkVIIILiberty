...
section=definitions['anchor_cotter'].section(Part.makePlane(30,30,V(0,-15,-15),V(1,0,0)))
...
for hand in ['Port','Starboard']:
 ...
 borefaces=cylinders(bracket,rc['pin_bore_radius'])+cylinders(anchor,rc['pin_bore_radius']);shaft=cylinders(pin,c['pin_diameter']/2)
