...
base=App.Placement(V(*r['interfaces']['PortHighSpeedBrake']['center_world_mm']),App.Rotation());target_names=['PortHighSpeedBrake'+v for v in ['LongBand','ShortBand','AnchorEnd','LongFrontEnd','ShortFrontEnd']]
...
context=[]
for name in [h+'HighSpeedBrake'+v for h in ['Port','Starboard'] for v in ['LongBand','ShortBand','AnchorEnd','LongFrontEnd','ShortFrontEnd']]:
