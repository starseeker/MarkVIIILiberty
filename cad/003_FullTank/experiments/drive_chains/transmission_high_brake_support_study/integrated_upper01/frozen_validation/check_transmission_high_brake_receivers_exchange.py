"""Reopen a receiving prototype and compare definitions/installed STEP material."""
...
if a.refined_case_mass:
 ...
 failed=read(out/'exchange_checks.json');control_path=out/'diagnostics/refined_mass_controls/qualification.json';control=read(control_path)
