...
made={}
for role,mark in [('case','M263'),('anchor_bracket','M362'),('mount_screw','MX60')]:
...
write(out/'report.json',dict(passed=all(v['passed'] for v in checks),checks=checks,controls=c,details=details,
 ...
 limits=details['limitations']+['Locking plates, anchor pins/cotters and stops not present in this prototype.',
