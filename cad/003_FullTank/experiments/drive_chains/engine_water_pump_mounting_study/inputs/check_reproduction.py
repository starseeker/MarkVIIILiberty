...
root=Path('/home/cyapp/MarkVIIILiberty');a=root/'cad/003_FullTank/experiments/drive_chains/engine_water_pump_mounting_study';b=root/'.work/engine-water-pump-mounting/fresh_nominal'
