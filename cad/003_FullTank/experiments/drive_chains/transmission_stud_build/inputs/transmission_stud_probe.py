...
parser.add_argument('--output',type=Path,default=ROOT/'transmission_stud_build')
        ...
        for role in ['inner','outer']:
            ...
            for setting in install[role]:
                ...
                for component,key,x in [('Stud',mark,setting['tail_x_mm']),('Nut','nut',stack['cap_seating_x_mm']),
                    ...
                    link.setLink(definitions[key]);link.LinkPlacement=App.Placement(App.Vector(x,0,0),App.Rotation())
