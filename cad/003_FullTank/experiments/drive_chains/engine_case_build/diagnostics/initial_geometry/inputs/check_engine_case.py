...
try:
    ...
    near('upper case joint datum',upper.BoundBox.ZMin,0)
    near('lower case joint datum',lower.BoundBox.ZMax,0)
    ...
    for a1,b1 in [('FrontPivotBolt','FrontBracket'),('FrontPivotNut','FrontPivotLock')]:gap(a1+' to '+b1,byid['EngineSuspension_'+a1]['shape'],byid['EngineSuspension_'+b1]['shape'])
