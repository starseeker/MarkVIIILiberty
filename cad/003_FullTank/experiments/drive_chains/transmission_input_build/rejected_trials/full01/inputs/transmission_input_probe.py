...
try:
    ...
    names=['transmission_input_probe.py','transmission_input_parts.py','transmission_input_controls.json','transmission_input_sources.json',
    ...
    def link(parent,name,key,placement=None):
        ...
        expected[name]=obj.getGlobalPlacement().multiply(definitions[key].Shape.Placement)
    ...
    for n in range(2):
        ...
        gap(prefix+'inner_race','CenterBevelDrive_pinion',0 if n==0 else c['spline_gap'] if False else .1)
