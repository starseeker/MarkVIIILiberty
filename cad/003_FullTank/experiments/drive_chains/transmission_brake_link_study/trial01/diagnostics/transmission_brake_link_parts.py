...
def dimensions(c,support,upper,drum,track_outer_radius):
    ...
    lower_radius=track_outer_radius+c['future_rear_bracket_stock']+c['lower_head_radius']+c['lower_head_radial_clearance']
    ...
    return dict(clevis_half_width_mm=half,clevis_inner_half_width_mm=inner,
        ...
        lower_eye_relative_mm=list(lower),lower_anchor_radius_mm=lower_radius,
