...
try:
    ...
    names=[]
    for name,direction in [('isometric',(.7,-1,.55)),('cutaway',(.8,-1,.45)),('gear_core',(.7,-1,.5)),('exploded',(.7,-1,.4)),('relief',(.5,-1,.2)),('lower_service',(.4,-.7,-1)),('mounting_plan',(0,0,1))]:
        items=[]
        for row in r['occurrences']:
            ...
            if name=='cutaway' and row['assembly'] in ['EngineOilPumpFasteners','EngineOilPumpMounting'] and row['xyz'][0]>0:continue
            if name=='cutaway' and key=='mount_gasket':s=s.common(Part.makeBox(200,400,400,V(-200,-200,-200)))
            ...
            if name=='mounting_plan' and key not in ['lower_body','lower_driving_gear','lower_idler_gear','long_pin','short_pin','mount_gasket','mount_stud']:continue
            if name=='exploded':
                dz=0
    ...
    for suffix,view in [('figure_027_original.png','gear_core'),('figure_028_original.png','mounting_plan'),('figure_029_original.png','cutaway'),('figure_030_original.png','relief'),('figure_033_original.png','exploded'),('p305.jpg','exploded'),('figure_034_original.png','lower_service')]:
