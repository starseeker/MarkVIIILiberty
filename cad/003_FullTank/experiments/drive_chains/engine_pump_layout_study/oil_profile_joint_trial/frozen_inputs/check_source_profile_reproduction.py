...
root=Path('/home/cyapp/MarkVIIILiberty');a=root/'cad/003_FullTank/experiments/drive_chains/engine_pump_layout_study/oil_profile_joint_trial';b=root/'.work/engine-oil-pump/source_profile_reproduction'
...
checks=dict(identical_inputs=x[0]['input_hashes']==y[0]['input_hashes'],identical_serialized_shapes=x[1]==y[1],identical_object_properties=x[2]==y[2],identical_types=x[3]==y[3],physical_counts=x[0]['physical_count']==y[0]['physical_count']==146,identical_controls_and_datums=x[0]['controls']==y[0]['controls'] and x[0]['datums']==y[0]['datums'])
