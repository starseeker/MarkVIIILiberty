...
try:
    ...
    keys=['Def_ClutchDrive_'+k for k in parts]+['Def_PumpMount_'+k for k in mp]+[old['InputHousing_coupling']['target'].Name]
    ...
    draw(new+['InputHousing_coupling'],'section','Clutch-drive centre section | head/socket and hidden casting contours inferred',(0,-1,0),clip)
